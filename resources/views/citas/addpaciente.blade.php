                        ...
                        <form action="{{route('paciente.store')}}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3 col-md-push-8"{{ $errors->has('cedula') ? 'has-error' : '' }}>
                                    ...
                                    <input type="text" name="cedula" id="cedula"  class="form-control" required class="form-control" pattern="^([V|v|E|e]{1})-([0-9]{6,8})-?([0-9]{1,1}?)$" title="La cédula de identidad debe tener el formato V-00000000 sin puntos. En caso de niños sin cédula ingresar V-00000000-0" placeholder="Cédula" autocomplete="off">
