                        ...
                        <form action="{{route('referencias.update',$referencia->id)}}" method="POST">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6 col-md-push-8" {{ $errors->has('telefono') ? 'has-error' : '' }}>
                                    ...
                                    <input type="text" name="telefono" required class="form-control" id="telefono" pattern="^[0-9]{4}-[0-9]{7}$" maxlength="12" title="El formato del teléfono debe ser el siguiente 0424-3333333" placeholder="Teléfono Referencia" value="{{$referencia->telefono_ref}}">
