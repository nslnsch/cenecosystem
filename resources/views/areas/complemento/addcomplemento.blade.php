        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card" style="border-radius: 10px;">
                    ...
                    <div class="card-body">
                        <form action="{{route('subestudios.store')}}" method="POST">
                            @csrf
                            <div class="form-group row">
                                <div class="col-md-4 col-md-push-8" {{ $errors->has('cod_estudio') ? 'has-error' : '' }}>
                                    ...
                                    <select name="cod_estudio" id="cod_estudio" required class="form-control" title="Codigo del Estudio">
                                        <option selected>Seleccione un Estudio</option>
                                ...
                                <div class="col-md-4 col-md-push-8"  {{ $errors->has('subestudio') ? 'has-error' : '' }}>
                                    ...
                                    <input type="text" name="subestudio" id="subestudio" required class="form-control" placeholder="Nombre del Sub-Estudio" autocomplete="off" maxlength="25" title="EL nombre del sub-estudio no debe estar vacio y debe contener solo letras,numeros y caracteres especiales">
                                ...
                                <div class="col-md-4 col-md-push-8"  {{ $errors->has('precio') ? 'has-error' : '' }}>
                                    ...
                                    <input type="text" name="precio" id="precio" required class="form-control" placeholder="Precio del Sub-Estudio" autocomplete="off" maxlength="25" title="EL Precio del sub-estudio no debe estar vacio y debe contener solo numeros">
                                    {!! $errors -> first('precio', '<span class=error>:message</span>') !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-primary" id="registrar" onclick="return confirm('Verifique los datos del SubEstudio antes de Registrar?')"><i class="fas fa-plus"></i> Registrar</button>
                                </div>
                                <div class="col-md-6">
