            ...
            <div class="col-md-12">
                <div class="card" style="border-radius: 10px;">
                    <div class="card-header text-primary text-center">
                        <h4>Nuevo Estudio</h4><i class="far fa-question-circle" style="float: right;margin-top: -30px;font-size: 20px;" data-toggle="modal" data-target="#modal_help" title="Ayuda"></i>
                    </div>
                    <div class="card-body">
                        <form action="{{route('estudio.store')}}" method="POST">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6 col-md-push-8" {{ $errors->has('consultorio') ? 'has-error' : '' }}>
                                    ...
                                    <select name="consultorio" id="id_consult" required class="form-control" pattern="^[a-zA-ZÁÉÍÓÚñáéíóúÑ]{11}[1-9]{1}" title="Codigo del Consultorio">
                                ...
                                <div class="col-md-6 col-md-push-8"  {{ $errors->has('name') ? 'has-error' : '' }}>
                                    ...
                                    <input type="text" name="name" id="name" required class="form-control" placeholder="Nombre del Estudio" pattern="^[a-zA-ZÁÉÍÓÚñáéíóúÑ]{2,20}" autocomplete="off" title="EL nombre del estudio no debe estar vacio y debe contener solo letras de un minimo de 2 caracteres y un maximo de 20">
                                    {!! $errors -> first('name', '<span class=error>:message</span>') !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-primary" id="registrar" onclick="return confirm('Verifique los datos del Estudio antes de Registrar?')"><i class="fas fa-plus"></i> Registrar</button>
                                </div>
                                <div class="col-md-6">
