        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card" style="border-radius: 10px;">
                    <div class="card-header ">Lista de Consultorios
                        <a href="{{route('consultorio.create')}}" title="Registrar un nuevo Consultorio"><button class="btn btn-primary d-block float-right ml-auto"><i class="fas fa-user-plus"></i> Nuevo</button></a>
                    </div>
                    <div class="card-body">
