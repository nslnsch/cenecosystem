                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 inner-addon left-addon">
                                    ...
                                    <input autofocus id="email" placeholder="Ingrese E-mail" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required  pattern="[a-zA-Z0-9.+_-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9.-]+" title="Formato de Correo: ceneco@ceneco.com" autofocus="autofocus">
                                    @error('email')
