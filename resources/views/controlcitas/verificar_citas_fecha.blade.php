                        ...
                        <form action="{{route('verify_cita_fecha')}}" method="get">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-md-push-8">
                                    Desde <input type="date" class="form-controller" id="fecha1" maxlength="25" name="fecha1" autofocus placeholder="Buscar" title="Buscar citas por rango de fechas" style="border-width: 0;outline: 0;" autocomplete="off" required> Hasta <input type="date" class="form-controller" id="fecha2" maxlength="25" name="fecha2" autofocus placeholder="Buscar" title="Buscar citas por rango de fechas" style="border-width: 0;outline: 0;" autocomplete="off" required><button type="submit" class="btn btn-primary" id="Buscar" title="Buscar"><i class="fas fa-search"></i> Buscar</button>
                                </div>
